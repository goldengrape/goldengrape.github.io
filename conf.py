...
BLOG_AUTHOR = "Golden Grape"  # (translatable)
BLOG_TITLE = "GoldenGrape's Blog"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://goldengrape.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://example.com/"
BLOG_EMAIL = "https://twitter.com/goldengrape"
BLOG_DESCRIPTION = "This is a blog site for GoldenGrape."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ("/archive.html", "文章存档"),
        ("/categories/", "标签"),
        ("/categories/jiao-cheng/", "教程"),
        ("/github-projects/", "开源项目"),
        ("/rss.xml", "RSS feed"),
    ),
}
...
# (translatable)
CONTENT_FOOTER = 'Contents &copy; {date}         <a href="{email}">{author}</a> - Powered by         <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-113165714-1"></script>
<script>
