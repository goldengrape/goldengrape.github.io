...
# 
# 人眼的角膜，是具有球差的，是一个“正球差”的凸透镜，也就是说，周边的屈光力更强，中央的弱一些，周边的光线会被聚焦得更**近** ，人眼的晶状体，这东西不但形状不是标准球面镜，内部的折射率还是渐变的，最终的结果是人眼的晶状体是一个“负球差”的透镜。一定程度上，两个透镜的结合导致球差能够互相抵消一部分。
# 
...
# * [参考文献2: A new intraocular lens design to reduce spherical aberration of pseudophakic eyes.](https://www.ncbi.nlm.nih.gov/pubmed/12458861)
# 
# 第一枚上市的非球面人工晶体是AMO公司(现在属于强生)的Tecnis Z9000, [FDA: 09/05/2001 ](https://www.accessdata.fda.gov/scripts/cdrh/cfdocs/cfpma/pma.cfm?id=P990080S001)
# 
